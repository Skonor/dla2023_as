...
class RawNet2Ablations(BaseModel):
    def __init__(self, sinc_filter_length, hidden_channels, gru_dim, use_abs=True, bn_gru=True, min_low_hz=0, min_band_hz=0, **batch):
        ...
        self.sinc_layer = SincConv(channel1, sinc_filter_length, min_low_hz=min_low_hz, min_band_hz=min_band_hz)
